...
namespace QbSync.QbXml.Tests.QbXml
{
    ...
    {
        [Test]
        public void BasicDataAddExtResponseTest()
        {
            ...
            var dataExtAddResponse = new DataExtAddResponse();
            var response = dataExtAddResponse.ParseResponse(QuickBooksTestHelper.CreateQbXmlWithEnvelope(ret, "DataExtAddRs"));
